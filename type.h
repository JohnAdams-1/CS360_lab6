...
#include <libgen.h> 
#include <string.h> 
#include <sys/stat.h> // define shorter TYPES for convenience 
...
#define BLKSIZE 1024 // Block number of EXT2 FS on FD 
#define SUPERBLOCK 1 
#define GDBLOCK 2

#define ROOT_INODE 2 // Default dir and regular file modes 
#define DIR_MODE 0x41ED 
#define FILE_MODE 0x81AE 
#define SUPER_MAGIC 0xEF53 
#define SUPER_USER 0 // Proc status 
#define FREE 0 
#define BUSY 1 // file system table sizes 
#define NMINODE 100 
#define NMTABLE 10 
#define NPROC 2 
#define NFD 10 
#define NOFT 40 // Open File Table 
typedef struct oft{ 
  int mode; 
  int refCount; 
...
typedef struct proc{ 
  ...
  struct minode *cwd; 
  OFT *fd[ NFD]; 
  }PROC; // In-memory inodes structure 
...
}MINODE; // Open file Table // opened file instance 
